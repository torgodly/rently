<x-app-layout>
    ...
    <section class="reviews" id="reviews">
        <div class="heading">
            ...
            <h1>خطوات سهلة لإتمام حجزك الإلكتروني <br/> <br/>
                خطوات الحجز
            </h1>
        </div>
        <div class="reviews-container">
            <div class="box">
                ...
                <h1>أدخل التواريخ واختر المركبة</h1>

                <p>
                    اختر السيارة التي تفضّلها، <br/> <br/> تاريخ الاستلام والتسليم وموقع الإستلام .
                </p>
            ...
            <div class="box">
                ...
                <h1>أضف تفاصيل السائق</h1>

                <p>
                    أضف تفاصيل السائق ومعلومات التواصل <br/> <br/> لتجربة سلسة عند إستلام السيارة.
                </p>
            </div>
            <div class="box">

                <h1> ادفع مباشرةً أو لاحقاً</h1>

                <p>
                    أدخل تفاصيل بطاقتك الائتمانية <br/> <br/> أو اختار من طرق الدفع المتاحة.
                </p>
            </div>
        </div>
    </section>
